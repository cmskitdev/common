/**
 * Common types and interfaces for Notion blocks system.
 */
...
export interface Block {
  ...
  ListItems?: Block[]; // For list containers
}
...
/**
 * Color utility type for Notion colors.
 */
...
/**
 * Block type union for type safety.
 */
